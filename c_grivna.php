...
<h1>Grivnas vs Euros</h1>

<?php

$exchange_rate=$_SESSION['exrates']['eur-gri'] ?? 0;
...
{   
    ...
    $not_selected_currency = ($selected_currency === 'Grivnas') ? 'Euros' : 'Grivnas';
...
<!-- FORM -->
    ...
    <div class="addition">
        <form action="/php/site_conversion/c_grivna.php" method='POST'>
            <label for="options">Selling</label><br><br>
            <select id="options" name="options">
                <option value="Euros" id="eur">GRIVNAS</option> 
                <option value="Grivnas" id="gri">EUROS</option>
            </select>
...
if (isset($_POST['nombre1'])) {
  ...
  $rate= ($selected_currency==='Grivnas') ? $exchange_rate : number_format((1 / $exchange_rate), 4);
