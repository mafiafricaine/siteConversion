...
<h1>Francs RDC vs Euros</h1>

<?php

$exchange_rate=$_SESSION['exrates']['eur-rdc'] ?? 0;
...
{   
    ...
    $not_selected_currency = ($selected_currency === 'Francs') ? 'Euros' : 'Francs';
...
<!-- FORM -->
    ...
    <div class="addition">
        <form action="/php/site_conversion/c_rdc.php" method='POST'>
            <label for="options">Selling</label><br><br>
            <select id="options" name="options">
                <option value="Euros" id="eur">FRANCS-RDC</option> 
                <option value="Francs" id="rdc">EUROS</option>
            </select>
...
if (isset($_POST['nombre1'])) {
  ...
  $rate= ($selected_currency==='Francs') ? $exchange_rate : number_format((1 / $exchange_rate), 4);
